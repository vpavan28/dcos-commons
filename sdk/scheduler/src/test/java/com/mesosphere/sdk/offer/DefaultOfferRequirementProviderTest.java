...
public class DefaultOfferRequirementProviderTest {
    ...
    private void finishNewOfferTest(OfferRequirement offerRequirement, List<String> tasksToLaunch, PodInstance podInstance) throws InvalidRequirementException {
        ...
        Map<String, String> taskEnv = CommonIdUtils.fromEnvironmentToMap(taskCommand.getEnvironment());
    ...
    public void testNewOfferRequirementDocker() throws Exception {
        ...
        Map<String, String> envvars = CommonIdUtils.fromEnvironmentToMap(taskInfo.getCommand().getEnvironment());
    ...
    public void testEnvironmentVariablesAddedToNewOfferRequirement() throws Exception {
        ...
        envvars = CommonIdUtils.fromEnvironmentToMap(taskInfo.getCommand().getEnvironment());
