...
public class DockerVolumeSpecTest {
    ...
    public void testDockerVolumeNoOptions() {
        new DockerVolumeSpec(
                DISK_SIZE_MB, VolumeSpec.Type.DOCKER, "testVolume", "pxd", "", "testPath", "role", "", "principal", "VOLUME");
    }
    ...
    public void testDockerVolumeNoVolumeName() {
        new DockerVolumeSpec(
                DISK_SIZE_MB, VolumeSpec.Type.DOCKER, "", "pxd", "", "testPath", "role", "", "principal", "VOLUME");
    }
