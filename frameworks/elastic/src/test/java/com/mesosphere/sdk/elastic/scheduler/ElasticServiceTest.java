...
public class ElasticServiceTest extends BaseServiceSpecTest {
    ...
    public static void beforeAll() {
        ...
        ENV_VARS.set("MESOS_SANDBOX", "/mnt/mesos/sandbox");
        ...
        ENV_VARS.set("MASTER_NODE_DOCKER_VOLUME_NAME", "MasterNodeVolume");
        ...
        ENV_VARS.set("DATA_NODE_DOCKER_VOLUME_NAME", "DataNodeVolume");
        ...
        ENV_VARS.set("INGEST_NODE_DOCKER_VOLUME_NAME", "IngestNodeVolume");
        ...
        ENV_VARS.set("COORDINATOR_NODE_DOCKER_VOLUME_NAME", "CoordinatorNodeVolume");
        ...
        ENV_VARS.set("KIBANA_DOCKER_VOLUME_NAME", "KibanaVolume");
